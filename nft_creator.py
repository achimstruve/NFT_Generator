...
generate_meta_data = True
### Create new collection if not existing yet
if not os.path.isfile('U:/Dokumente/Prv/Programmierung/NFT_Generator/images') and generate_images:
    os.mkdir(f'./images')

    ###  Define Traits and their Rarities  ###
    ...
    ###  Map Traits to their Image Names  ###
    ...
    # save data for metadata creation
    os.mkdir(f'./metadata')
...
if generate_meta_data:
    ...
    IMAGES_BASE_URL = "https://gateway.pinata.cloud/ipfs/QmUN5Nm2fyjQEyEpRT3Q8JnBGxuBAptjELtLjGQqUexZa2/"
    PROJECT_NAME = "NFT_Test_Punk"
